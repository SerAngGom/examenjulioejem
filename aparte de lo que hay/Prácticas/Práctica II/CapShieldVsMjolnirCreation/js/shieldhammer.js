...
function initMyDOM(){
    ...
    bg.appendChild(divcap);

    //id="capshield" class="superheroweapon" style="top: 270px; left: 0px; font-size: 60px;
    let attcapid = document.createAttribute("id");
    attcapid.value = "capshield";
    divcap.setAttributeNode(attcapid);
    let attcapcl = document.createAttribute("class");
    attcapcl.value = "superheroweapon";
    divcap.setAttributeNode(attcapcl);
    let attcapst = document.createAttribute("style");
    attcapst.value = "top: 270px; left: 0px; font-size: 60px";
    divcap.setAttributeNode(attcapst);

    let letterO = document.createTextNode("O");
    divcap.appendChild(letterO);
    //--
    //MJ
    //--
    let divmj = document.createElement("div");
    bg.appendChild(divmj);

    // id="mjolnir" class="superheroweapon" style="top: 280px; left: 760px; font-size: 40px; transform: rotate(270deg);
    let attmjid = document.createAttribute("id");
    attmjid.value = "mjolnir";
    divmj.setAttributeNode(attmjid);
    let attmjcl = document.createAttribute("class");
    attmjcl.value = "superheroweapon";
    divmj.setAttributeNode(attmjcl);
    let attmjst = document.createAttribute("style");
    attmjst.value = "top: 280px; left: 760px; font-size: 40px; transform: rotate(270deg)";
    divmj.setAttributeNode(attmjst);

    let letterT = document.createTextNode("T");
    divmj.appendChild(letterT);
}
